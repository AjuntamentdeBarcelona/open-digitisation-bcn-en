...
These principles are contained in the Decalogue titled *Our Digital Service Stan-dards* (see Annexe 12.1):
...
Between 2016 and 2017, the City Council launched *Decidim.Barcelona* and *Sentilo*, applications that hace been developed as its own free software.
